    ...
    return (
        <Box id={'projects'} style={{height: 'auto'}}>
            ...
            <div className={s.projects}>
                ...
                <Project img={crypto} link={'https://nastyasap.github.io/coincap_test/#/'}
                         title={'Cryptocurrencies'}
                         description={'List of al cryptocurrencies, information about every item and possibility of adding it to your wallet. Stack: React, Redux, Typescript, Axios, redux-saga, redux-toolkit, styled-components, react-router-dom, redux-persist, recharts. '}/>
